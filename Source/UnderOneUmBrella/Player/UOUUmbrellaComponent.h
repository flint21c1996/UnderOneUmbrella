...
public:
	...
	// 빛 반사 조준을 고정 각도 단위로 보정할지 정합니다.
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Umbrella|Aim")
	bool bSnapLightReflectingAimDirection = true;

	// 빛 반사 조준의 각도 보정 단위입니다. 22.5도는 16방향입니다.
