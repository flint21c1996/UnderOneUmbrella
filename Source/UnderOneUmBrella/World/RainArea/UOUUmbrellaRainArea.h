...
protected:
	...
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Rain|Falling", meta = (UIMin = "-3000.0", UIMax = "0.0", DisplayPriority = "4", ToolTip = "비 파티클의 Z 낙하 속도입니다. 아래로 떨어지는 값을 Niagara에 직접 전달하므로 보통 음수로 설정합니다."))
