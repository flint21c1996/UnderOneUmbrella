...
// 물의 부피 계산에는 참여하지 않고, 지정한 Basin Target 자신의 수면 월드 Z에 맞춰 Owner Actor 또는 지정 컴포넌트의 높이를 갱신합니다.
...
public:
	...
	// 물이 장치에 의해 서서히 변할 수 있으므로 매 프레임 WaterTile 자신의 수면 월드 Z를 따라갑니다.
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Water Platform", meta = (ToolTip = "WaterTile 자신의 수면 월드 Z에 맞춰 이동시킬 플랫폼 SceneComponent입니다. 비워두면 이름/태그 탐색 후 Platform Actor의 RootComponent를 사용합니다."))
	...
	// Target WaterTile 자신의 수면 월드 Z에 추가로 더할 오프셋입니다.
	// 플랫폼 피벗이 중앙에 있거나 수면보다 위에 떠 있어야 할 때 사용합니다.
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Water Platform", meta = (ToolTip = "Target WaterTile 자신의 수면 월드 Z에 추가로 더할 오프셋입니다."))
	...
	// 마지막으로 계산된 플랫폼 목표 월드 Z입니다. TargetSurfaceWorldZ + SurfaceOffsetZ입니다.
	...
	// 현재 TargetActor WaterTile 자신의 수면 월드 Z를 반환합니다.
