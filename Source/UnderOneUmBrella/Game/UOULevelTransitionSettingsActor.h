...
public:
	...
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Level Transition|Target", meta = (AllowedClasses = "/Script/Engine.World", DisplayName = "Previous Level", ToolTip = "Development travel UI or transition actors use this as the previous level. If empty, previous-level requests fall back to the title level."))
